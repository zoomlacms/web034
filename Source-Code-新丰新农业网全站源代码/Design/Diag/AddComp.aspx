<%@ page language="C#" autoeventwireup="true" inherits="Design_Diag_AddComp, App_Web_3zonc5ux" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
           ...
           $(".category").click(function () {
               ...
               $("#compview").load("/Design/Diag/" + type + "/Add.html?m=" + Math.random(), function () {
                   ...
                   $(".domItem").click(function () {
                       ...
                       model.config.style += "position:absolute;top:" + top + "px;left:40%;";
