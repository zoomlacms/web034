<%@ page language="C#" autoeventwireup="true" inherits="Design_Diag_Common_Edit, App_Web_ixkopqmu" masterpagefile="~/Design/Master/Edit.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div role="tabpanel" class="tab-pane" id="option">
         <div class="control-section-divider labeled">自定义设置</div>
           <hr class="divider-long"/>
        <div class="setting-row">
            <div><label class="row-title">Class属性设置</label></div>
            <input id="classattr_t" type="text" class="form-control " />
        </div>
        <hr class="divider-long"/>
        <div class="setting-row">
            <div><label class="row-title">Style属性设置</label></div>
