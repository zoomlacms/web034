<%@ page language="C#" autoeventwireup="true" masterpagefile="~/Guest/Baike/Baike.master" clientidmode="Static" validaterequest="false" inherits="manage_GuestBook_BkAlter, App_Web_nwdk2qir" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div><asp:TextBox runat="server" ID="Why_T" CssClass="form-control" TextMode="MultiLine" Height="80"></asp:TextBox></div>
