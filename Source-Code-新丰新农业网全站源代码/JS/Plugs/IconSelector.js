...
iconSelctor.prototype.tlp = '<input type="text" id="icon_text_@id" class="form-control text_300" /> <span id="icon_span_@id"></span> <span class="fa fa-angle-double-left" style="font-size:20px;"></span> <button type="button" id="icon_btn_@id" class="btn btn-primary">图片地址或奥森图标</button>';
iconSelctor.prototype.Init = function () {
    var ref = this;
    $("#" + ref.id).hide();
    var html = ref.tlp.replace(/@id/g, ref.id);
