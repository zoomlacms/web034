<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_SiteInfo, App_Web_1ygpitnj" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" enableviewstate="False" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr >
            ...
            <td><asp:TextBox ID="TextBox9" runat="server" TextMode="MultiLine" class="form-control m715-50" style="height:60px;"></asp:TextBox></td>
        </tr>
        <tr >
            <td class="tdbgleft"><strong><%:lang.LF("网站META网页描述") %>：</strong></td>
            <td><asp:TextBox ID="TextBox10" runat="server" TextMode="MultiLine" class="form-control m715-50" style="height:60px;"></asp:TextBox></td>
        </tr>
        <tr >
            <td class="tdbgleft"><strong><%:lang.LF("版权信息") %>：</strong></td>
            <td><asp:TextBox ID="TextBox8" runat="server" TextMode="MultiLine"  class="form-control m715-50" style="height:100px;"></asp:TextBox></td>
        </tr>
        <tr >
