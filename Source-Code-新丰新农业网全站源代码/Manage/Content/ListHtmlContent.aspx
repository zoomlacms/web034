<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_ListHtmlContent, App_Web_4l5orxfu" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <div class="pull-left">
                    <div class="pull-left">
                        ...
                        <asp:DropDownList ID="DropDownList1" Width="120" CssClass="form-control" runat="server">
                            ...
                            <asp:ListItem Value="2">ID检索</asp:ListItem>
                            <asp:ListItem Value="1">标题检索</asp:ListItem>
                            <asp:ListItem Value="3">录入者检索</asp:ListItem>
                        </asp:DropDownList>
                    </div>
    ...
    <div class="panel panel-default" style="padding:0px;">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="生成操作">
				...
				<a href="ListHtmlContent.aspx?GeneralID=<%# Eval("GeneralID") %>" class="option_style"><i class="fa fa-trash-o" title="删除"></i>删除</a>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" />
            </asp:TemplateField>
        </Columns>
