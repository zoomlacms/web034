<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_NodeManage, App_Web_ohp2kgpc" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover nodelist_div">
	<tr class="gridtitle text-center">
		...
		<td class="td_s text-center"><strong>ID</strong></td>
