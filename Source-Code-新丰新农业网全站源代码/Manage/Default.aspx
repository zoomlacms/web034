<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Default, App_Web_ttpcy0qx" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
<html>
<head>
...
<div class="margin-15 padding0 m_top_right">
    ...
    <div class="pull-right hidden-lg hidden_group" id="search_div">
        <div class="input-group input-group-sm">
            <asp:TextBox runat="server" ID="keyText" class="form-control input-control nofocus" placeholder="快速搜索  回车确认" onkeydown="return IsEnter(this);" /><i class="glyphicon glyphicon-search"></i>
        </div>
    </div>
    </div>
</div>
...
<ul class="menu2">
	...
	<li class="menu2_9"><a onclick="showleft('menu2_9','Guest/GuestCateMana.aspx?Type=1')"><%:lang.LF("百科问答贴吧") %></a></li>
...
<ul class="menu6">
    ...
    <li class="menu6_8"><a onclick="showleft('menu6_8','APP/WSApi.aspx')">整合接口</a></li>
</ul>
<ul class="menu7">
...
<%--	<ul id="menu3_12" class="m_left_ulin">
	...
	<div id="menu7" class="m_left_ul">
		...
		<ul class="m_left_ulin" id="menu7_3">
			...
			<li id="menu7_3_2"><a href="javascript:;" data-url="Counter/Ip.aspx"><%:lang.LF("全站统计") %></a></li>
			<li id="menu7_3_3"><a href="javascript:;" data-url="Counter/Month.aspx"><%:lang.LF("每日统计") %></a></li>
			<li id="menu7_3_4"><a href="javascript:;" data-url="Counter/Year.aspx"><%:lang.LF("每月统计") %></a></li>
			<li id="menu7_3_5"><a href="javascript:;" data-url="Counter/Local.aspx"><%:lang.LF("地区数据") %></a></li>
			<li id="menu7_3_6"><a href="javascript:;" data-url="Counter/Browser.aspx"><%:lang.LF("浏览信息") %></a></li>
			<li id="menu7_3_7"><a href="javascript:;" data-url="Counter/Os.aspx"><%:lang.LF("操作系统") %></a></li>
		</ul>
...
<%--		<li id="menu9_1_8"><a href="javascript:;" data-url="WorkFlow/AffairManage.aspx"><%:lang.LF("公文管理") %></a></li>--%>
		...
		<ul class="m_left_ulin" id="menu9_4" style="height:700px;overflow:auto;">
			...
			<li><a href="javascript:" data-url="AddCRM/OptionManage.aspx"><%:lang.LF("选项管理") %></a></li>     
...
<%--        <li id="menu9_8_6"><a href="javascript:;" data-url="Plus/TxtLog.aspx?LogType=4">支付日志</a></li>--%>
 <%--       <li id="menu9_8_6"><a href="javascript:;" data-url="Plus/AuditNotes.aspx">审核记录</a></li>--%>
        ...
        <ul class="m_left_ulin" id="menu9_9">
            ...
            <li id="menu9_9_3"><a href="javascript:;" data-url="Plat/CompList.aspx">公司管理</a></li>
            <li id="menu9_9_2"><a href="javascript:;" data-url="Plat/PlatConfig.aspx">能力配置</a></li>
        </ul>
