<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_ClassManage, App_Web_bsxr3gi2" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr id="<%#Eval("GroupID") %>" ondblclick="ShowTabs(this.id)">
                    ...
                    <td height="22" align="center">
                        <a href="AddClass.aspx?cid=<%#Eval("GroupID")%>" class="option_style"><i class="fa fa-pencil" title="修改"></i></a> 
                        <a href="?menu=delete&cid=<%#Eval("GroupID")%>" OnClick="return confirm('确实要删除此学员?');" class="option_style"><i class="fa fa-trash-o" title="删除"></i></a>
                        <a href="ViewStudio.aspx?cid=<%#Eval("GroupID")%>" class="option_style"><i class="fa fa-users" title="学员"></i>学员</a> 
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
