<%@ page language="C#" autoeventwireup="true" inherits="manage_Exam_InsertClass, App_Web_bsxr3gi2" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
                    ...
                    <td height="22" align="center">
                        <a href="InsertClass.aspx?cid=<%#Eval("CID")%>" class="opiton_style"><i class="fa fa-pencil" title="修改"></i></a> 
                        <a href="?menu=delete&cid=<%#Eval("CID")%>" OnClick="return confirm('确实要删除此学员?');" class="option_style"><i class="fa fa-trash-o" title="删除"></i>删除</a>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
