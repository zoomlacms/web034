<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Papers_System_Manage, App_Web_bsxr3gi2" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
         ...
         CssClass="table table-striped table-bordered table-hover" EnableTheming="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                    <ItemTemplate>
                        <a href="Paper_QuestionManage.aspx?pid=<%#Eval("id") %>" class="option_style"><i class="fa fa-magic" title="题目管理"></i>题目管理</a>&nbsp;|&nbsp;
                        <%--<a href="Paper_Subject_Manage.aspx?pid=<%#Eval("id") %>">浏览试题</a>&nbsp;|&nbsp;--%>
                        <a href="Add_Papers_System.aspx?menu=Edit&paper_id=<%#Eval("id") %>" class="option_style"><i class="fa fa-pencil" title="修改"></i>修改试卷</a>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                </asp:TemplateField>
            </Columns>
