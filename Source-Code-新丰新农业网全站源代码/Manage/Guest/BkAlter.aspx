<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Guest_BkAlter, App_Web_qynvjome" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content  ContentPlaceHolderID="Content" Runat="Server">
    <div>
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td class="text-center"><strong>开放分类</strong></td>
                <td>
                    <select name="bktype" class="form-control text_300">
                        <option value="0">请选择分类</option>
                        <asp:Literal ID="BkType_Li" runat="server" EnableViewState="false"></asp:Literal>
                    </select>
                </td>
            </tr>
            <tr>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    <script>
        function CheckVal(val) {
            $("[name='bktype'] option[value='" + val + "']")[0].selected = true;
        }
    </script>
</asp:Content>
