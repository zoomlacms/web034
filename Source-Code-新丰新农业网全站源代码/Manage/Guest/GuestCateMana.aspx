<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Guest_GuestCateMana, App_Web_qynvjome" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <ItemTemplate>
            <tr data-layer="1" data-id="<%#Eval("CateID") %>" data-pid="0"  onclick="ShowChild(this,<%#Eval("CateID") %>);" ondblclick="ToggleChild(this);">
                ...
                <td class='optd'>
                    ...
                    <%#(Eval("GType").ToString()=="0")?"":"<a href=\"javascript:;\" onclick=\"ShowCate(0,"+Eval("CateID")+");\" class='option_style'><i class='fa fa-plus' title='添加'></i>版面</a>" %>
