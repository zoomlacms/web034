<%@ page language="C#" autoeventwireup="true" inherits="manage_Mail, App_Web_p4xdipqx" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <td colspan="7">
                <div>
                    ...
                    <div id="Import" style="display: none;float:left;width:360px;">
                        <ZL:FileUpload ID="fileImps" CssClass="form-control pull-left" runat="server" />
            ...
            <ItemTemplate>
                <tr ondblclick="location.href('MailSet.aspx?ID=<%#Eval("ID") %>')">
                    ...
                    <td width="150" align="center">
                        <a href="MailSet.aspx?ID=<%#Eval("ID") %>" class="option_style"><i class="fa fa-pencil" title="修改"></i></a>
                        <asp:LinkButton ID="LnkDelete" runat="server" CommandName="DeleteAdmin" OnClientClick=" return confirm('确定删除此邮箱?');" CommandArgument='<%# Eval("ID")%>' CssClass="option_style"><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
