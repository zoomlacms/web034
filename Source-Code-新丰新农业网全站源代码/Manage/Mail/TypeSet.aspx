<%@ page language="C#" autoeventwireup="true" inherits="manage_Mail_TypeSet, App_Web_p4xdipqx" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ItemTemplate>
                <tr ondblclick="location.href('MailType.aspx?Type=<%#Eval("ID") %>')">
                    ...
                    <td width="450" align="center" title="双击修改" style="cursor: pointer">
                        <a href="MailType.aspx?Type=<%#Eval("ID") %>" class="option_style"><i class="fa fa-pencil" title="修改"></i></a>
                        <asp:LinkButton ID="LnkDelete" runat="server" CommandName="DeleteAdmin" OnClientClick=" return confirm('将删除类别下的全部邮箱信息！确实要删除此类别?');" CommandArgument='<%# Eval("ID")%>' CssClass="option_style"><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
