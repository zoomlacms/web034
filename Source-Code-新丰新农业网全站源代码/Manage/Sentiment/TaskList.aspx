<%@ page language="C#" autoeventwireup="true" inherits="Manage_Sentiment_Source, App_Web_kcxho3s4" masterpagefile="~/Manage/I/Default.master" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div> 
    <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"  EnableTheming="False"  
            ...
            <Columns>
                ...
                <a href="GetReport.aspx?Skey=<%#Eval("Condition") %>" class="option_style"><i class="fa fa-eye" title="查看"></i>查看报告</a>                
                </ItemTemplate>
                </asp:TemplateField>            
            </Columns>
