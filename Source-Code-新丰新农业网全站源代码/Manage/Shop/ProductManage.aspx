<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.ProductManage, App_Web_oeybqicj" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<ol id="BreadNav" class="breadcrumb navbar-fixed-top">
    ...
    <script type="text/javascript">
       ...
       <div id="divImp" class="divline">
            导入商城：<ZL:FileUpload  runat="server" style="display:inline;" ID="FileUpload1" />
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate> 
                        ...
                        <asp:LinkButton ID="Del1" runat="server" CssClass="option_style" CommandName="Del1" CommandArgument='<%# Eval("id") %>' OnClientClick="return confirm('确定要将商品移入回收站吗');" ><i class="fa fa-trash-o" title="删除"></i>删除</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </ZL:ExGridView>
