<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_LabelManage, App_Web_1ifhfkyz" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <ItemTemplate>
            <tr ondblclick="ckl('<%# Eval("LabelName") %>')">
                ...
                <td class="text-center" id="select">
                     <%# GetLabelLink(Eval("LabelID",""), Eval("LabelName",""), Eval("LabelType",""),"<i class='fa fa-pencil' title='修改'></i>")%>
                    <asp:LinkButton CssClass="option_style" runat="server" CommandName="Copy" CommandArgument='<%# Eval("LabelName") %>' OnClientClick="return confirm('确实复制此标签?');"><i class="fa fa-copy" title="复制"></i></asp:LinkButton>
                    ...
                    <asp:LinkButton CssClass="option_style" runat="server" CommandName="Del" CommandArgument='<%# Eval("LabelName") %>'  OnClientClick="return confirm('确实删除此标签?');"><i class="fa fa-trash-o" title="删除"></i></asp:LinkButton>
