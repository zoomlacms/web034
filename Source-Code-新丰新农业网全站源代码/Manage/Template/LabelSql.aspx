<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_LabelSql, App_Web_1ifhfkyz" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
	...
	<table class="table table-striped table-bordered table-hover">
	  ...
	  <tr>
		...
		<td class="text-left"><asp:TextBox ID="TxtLabelName" class="form-control text_md" runat="server" />
		  <asp:RequiredFieldValidator CssClass="tips" runat="server" ID="NReq" ControlToValidate="TxtLabelName" Display="Dynamic" ForeColor="Red" ErrorMessage="必须输入名称" SetFocusOnError="True" />
