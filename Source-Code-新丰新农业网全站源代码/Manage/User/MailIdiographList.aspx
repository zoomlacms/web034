<%@ page language="C#" autoeventwireup="true" inherits="manage_Qmail_MailIdiographList, App_Web_wopv4rdr" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
      ...
      <tr>
        <td valign="top" class="tdbg">
            ...
            <asp:CommandField HeaderText="操作" ShowDeleteButton="True"  HeaderStyle-Width="45px"/>
            </Columns>
          </ZL:ExGridView></td>
      </tr>
      <tr class="tdbg">
