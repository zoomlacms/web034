<%@ page language="C#" autoeventwireup="true" inherits="manage_User_MailTemplist, App_Web_wopv4rdr" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ZL:ExGridView ID="EGV" runat="server" Width="100%" AllowPaging="true" OnPageIndexChanging="EGV_PageIndexChanging" AutoGenerateColumns="False" OnRowCommand="Row_Command" class="table table-striped table-bordered table-hover">
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <asp:LinkButton ID="View" runat="server" CommandName="View" CommandArgument='<%# Eval("ID")%>' CssClass="option_style"><i class="fa fa-eye" title="预览"></i></asp:LinkButton>
                    <asp:LinkButton ID="update" runat="server" CommandName="update" CommandArgument='<%# Eval("ID")%>' CssClass="option_style"><i class="fa fa-pencil" title="修改"></i></asp:LinkButton>
