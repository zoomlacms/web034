<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.UserShop.UpdateModelField, App_Web_pj4aqe2y" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table class="table table-striped table-bordered table-hover">
            <tr class="tdbg">
                ...
                <td>
                    <asp:TextBox ID="Alias" runat="server" CssClass="" MaxLength="20"></asp:TextBox><font
