<%@ page language="C#" responseencoding="utf-8" autoeventwireup="true" inherits="ZoomLa.WebSite.Shop.PayOnline, App_Web_lmrxumte" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE HTML>
<html>
<head>
      ...
      <tr><td><div class="top_pay"><div class="pay_logo"><a href="/"><img src="<%:Call.LogoUrl %>"></a></div></div></td></tr>
        <tr><td>
            <div class="pay_tab" id="pay_con">
                ...
                <span>订单号：</span><asp:Label ID="OrderNo_L" runat="server"></asp:Label>
            ...
            <div class="PayPlat_s">
                ...
                <asp:Label ID="VMoneyPayPlat_L" runat="server"></asp:Label>
                <asp:Label ID="VMoneyPayed_L"  runat="server"></asp:Label>
