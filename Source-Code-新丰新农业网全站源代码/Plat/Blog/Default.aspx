<%@ page language="C#" autoeventwireup="true" enablesessionstate="True" inherits="Plat_Task_Default, App_Web_jani0a4q" masterpagefile="~/Plat/Main.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
	...
	<ItemTemplate>
	  <div class="msgitem" id="msgitem-<%#Eval("ID") %>">
		<div class="plat_left_div" style="position:absolute;">
		    ...
		    <div class="pull-left"><img class="imgface_mid uinfo" src="<%#Eval("UserFace") %>" onerror="this.src='/Images/userface/noface.gif';" title="<%#Eval("CUName") %>" data-uid="<%#Eval("CUser") %>" /></div>
		</div>
		<div class="msg_content_div plat_content_div">
		    <div class="content_head"><a href="javascript:;" onclick="ShowUser(<%#Eval("CUser") %>);" title="用户详情"><%#Eval("CUName") %></a> <%#GetColled() %></div>
		  ...
		  <div class="reply_op_div"> <%#GetReplyOP() %> <span class="glyphicon glyphicon-comment" title="回复" onclick="DisReplyOP(<%#Eval("ID") %>,0,'<%#Eval("CUName") %>');"></span> </div>
