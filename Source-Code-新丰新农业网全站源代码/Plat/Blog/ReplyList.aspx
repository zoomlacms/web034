c<%@ page language="C#" autoeventwireup="true" inherits="Plat_Blog_ReplyList, App_Web_jani0a4q" enableviewstate="false" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="replyrow" id="msgitem-<%#Eval("ID") %>">
  ...
  <div class="reply_body">
    ...
    <div class="replybottom grayremind">
        ...
        <span class="glyphicon glyphicon-comment" title="回复" onclick="DisReplyOP(<%#Eval("Pid") %>,<%#Eval("ID") %>,'<%#Eval("CUName") %>');"></span>
  </div>
