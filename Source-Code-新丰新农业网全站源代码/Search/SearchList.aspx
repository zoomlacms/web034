<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.SearchList, App_Web_ijxhj1ye" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE HTML>
<html lang="zh-cn">
<head>
<meta charset="utf-8" />
            ...
            <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                <form runat="server" id="myform">
                    <div class="input-group pull-left" style="width:408px;">
                        <select class="form-control pull-left text_md" style="border-right: none;" name="ddlnode" onchange="UpdateNode()">
