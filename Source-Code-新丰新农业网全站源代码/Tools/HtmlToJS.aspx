<%@ page language="C#" autoeventwireup="true" inherits="Tools_HtmlToJS, App_Web_evppe4bg" masterpagefile="~/Common/Master/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <script>
        function Convert() {
            ...
            for (var i = 0; i < strArr.length; i++) {
                ...
                if (result == "") { result = 'var html="' + strArr[i] + '"'; }
                else { result += '\n+"' + strArr[i] + '"'; }
            }
            result += ";";
            $("#JS_T").val(result);
