<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.MyContentpage, App_Web_cnr01u4a" enableEventValidation="false" viewStateEncryptionMode="Never" %>
         ...
         <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"  EnableTheming="False" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="标题"> 
                    <ItemTemplate>
                        <a href='ShowContent.aspx?Gid=<%# Eval("GeneralID") %>'>
