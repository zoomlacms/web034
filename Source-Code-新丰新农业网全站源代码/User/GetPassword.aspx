<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_GetPassword, App_Web_ppxpef1z" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ul class="list-unstyled">
                <asp:Panel ID="PnlStep1" runat="server" Visible="false">
                    ...
                    <li class="text-center">
                        ...
                        <a href="/User/Login.aspx" class="btn btn-default" style="margin-top: 10px;color:#fff;">返回登录</a>
                    </li>
                </asp:Panel>
                <asp:Panel ID="PnlStep2" runat="server" Visible="false">
                    <li>密码提示问题：<asp:Literal ID="LitQuestion" runat="server"></asp:Literal></li>
                    <li>密码提示答案：<asp:TextBox ID="TxtAnswer" runat="server" CssClass="form-control"></asp:TextBox></li>
