<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Register, App_Web_ppxpef1z" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
                                ...
                                <li>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 col-lg-4 col-md-4 col-xs-12 ">
                                            ...
                                            <asp:RegularExpressionValidator ID="rg4" Display="Dynamic" ForeColor="Red" runat="server" ControlToValidate="TxtMobile1" ErrorMessage="请输入正确的手机号码" ValidationExpression="^1(?:3|4|5|7|8)\d{9}$" />
                                        </div>
                                    </div>
                                    ...
                                    <div id="valPass">
                                        <span class="spantxt"><a id="idshow" class="atxt"></a></span><span class="spantxt"><a id="apass1" class="a_bor visible-xs"></a><a id="apass2" class="a_bor visible-xs"></a><a id="apass3" class="a_bor visible-xs"></a></span><span style="margin-left: 10px;"><br/>
                                            ...
                                            <asp:CustomValidator runat="server" ID="CV1" ErrorMessage="密码强度过低" Display="Dynamic" ForeColor="Red" EnableClientScript="true" 
                                                ClientValidationFunction="PwdCheck" ControlToValidate="TxtPassword" ValidationGroup="userVaid"></asp:CustomValidator>
                                        </span>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                                        ...
                                                        <td colspan="2" >
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-6 col-lg-6 col-md-6 col-xs-7 padding0">
                                                                    ...
                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TxtMobile" ErrorMessage="请输入正确的手机号码" ValidationExpression="^1(?:3|4|5|7|8)\d{9}$" Display="Dynamic" ForeColor="Red" />
                                                                </div>
                                                            </div>
...
<script type="text/javascript">
    ...
    function CheckIDCart() {
        ...
        else { checkcardmsg.innerHTML = ""; checkcardmsg.className = ""; }
    }
    //显示或关闭选填信息
